...
## [1.52.0-cvx.1] — 2026-09-26

Atualização para a 1.52.0 do DeskcommCRM (notas logo abaixo); as fontes da Convexy passam a vir com o sistema, sem depender do Google. Menu recolhido com o símbolo da marca: envie a arte quadrada em /admin/marca › "Símbolo (menu recolhido)". No menu da Convexy, o balão com o nome da porta ficou discreto e não prende mais; os submenus não têm balão e as seções ganharam espaço.
...
Menu novo da Convexy, desligado até ligar em /admin/sistema › Módulos opcionais ("Menu da Convexy"): portas grandes e o Início com conversas esperando, agenda e tarefas do dia. Cada empresa ganha "Tipo de negócio" em /admin/tenants (clínica: Contatos vira Pacientes). O banco ganha a coluna do tipo de negócio, aplicada pela atualização.

## [1.48.0-cvx.1] — 2026-09-25

Atualização para a 1.48.0 do DeskcommCRM (notas logo abaixo). O logo para o tema escuro passa a ser o do original: os logos já enviados continuam valendo. Mantém a identidade da Convexy e as imagens de `ghcr.io/victorrabyfs`.
## [1.48.0] — 2026-09-24
...
## [1.47.0-cvx.3] — 2026-09-24

Logo maior na barra lateral: passa de 28px para 40px de altura, nos temas claro e escuro. A tela de entrada não muda. Não há nada a fazer no `.env` nem no banco.
