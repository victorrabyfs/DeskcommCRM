...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/victorrabyfs/DeskcommCRM/main/hostgator-setup-kit/comecar.sh | bash
#
set -euo pipefail

REPO_URL="${REPO_URL:-https://github.com/victorrabyfs/DeskcommCRM.git}"
